...
LLM 통합, 지능형 시스템, 오케스트레이션 아키텍처를 전문으로 하는 개발자의 포트폴리오 웹사이트입니다. HTML5, CSS3, JavaScript로 구현된 모던하고 반응형 포트폴리오입니다.

## ✨ 주요 기능
- 🤖 **AI 챗봇 및 교육 어시스턴트 포트폴리오** - LLM 기반 프로젝트 소개
...
- 👨‍💼 **섹션 구성**:
  - 히어로 섹션 (AI 솔루션 개발 소개)
  - About (경력 및 역량)
  - Projects (6개의 프로젝트 - 착상담 AI 챗봇, 개발자 어시스턴트 등)
  - Skills (AI, 프론트엔드, 백엔드 기술)
  - Blog (AI 및 개발 기술 관련 게시물)
  - Contact (연락처 및 FAQ)
